...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/celestineemili/Desktop/Code Root/luminalogix/apps/server/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/celestineemili/Desktop/Code Root/luminalogix/apps/server/prisma/schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://celestineemili@localhost:5432/luminalogix"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  name      String\n  role      String   @default(\"user\") // or 'admin'\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "48b6fe62921201ec3756f65fe2a3c5b8e377543e28143c75dc5de6199b3335b1",
  "copyEngine": true
}
config.dirname = '/'
